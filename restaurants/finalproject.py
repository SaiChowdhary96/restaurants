...
# Fake Restaurants
'''
restaurants = [{'name': 'The CRUDy Crab', 'id': '1'},
{'name': 'Blue Burgers', 'id': '2'},
{'name': 'Taco Hut', 'id': '3'}]

# Fake items
items = [{'name': 'Cheese Pizza', 'price': '$5.99', 'id': '1'},
{'name' : 'Chocolate Cake', 'price': '$3.99', 'id': '2'},
{'name' : 'Cesar Salad', 'price': '$5.99', 'id': '3'},
{'name' : 'Iced Tea', 'price': '$0.99', 'id': '4'},
{'name' : 'Spinach Dip', 'price': '$1.99', 'id': '5'}]
'''
...
def newMenuItem(restaurant_id):
	...
	if request.method == 'POST':
		...
		item = MenuItem(name = name, item_type = item_type, price = price, 
...
def editMenuItem(restaurant_id, menu_id):
	...
	if request.method == 'POST':
		...
		item.item_type = request.form['type']
		item.price = request.form['price']
		session.add(item)
		session.commit()
		return redirect(url_for('showMenu', restaurant_id = restaurant_id))
	else:
		return render_template('editMenuItem.html', restaurant = restaurant, item = item, menu_id = menu_id)
